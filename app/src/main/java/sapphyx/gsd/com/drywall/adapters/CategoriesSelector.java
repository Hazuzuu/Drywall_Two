...
public class CategoriesSelector extends RecyclerView.Adapter<CategoriesSelector.MyViewHolder> {
    ...
    public static final int LFE = 6;
    public static final int PXL = 7;
    public static final int ERT = 8;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        switch (position){
            case CNL: {
                Glide.with(mContext)
                        .load("https://github.com/rgocal/Drywall/blob/master/archives/Campagna/170110_10-01.jpeg?raw=true")
                        .thumbnail(0.3f)
